...
import kr.co.chooz.user.dto.KakaoSocialLoginRequest;
...
public class RegisterUserController {
    ...
    public ResponseEntity<TokenResponse> socialLogin(@Valid @RequestBody KakaoSocialLoginRequest socialLoginRequest) {

        LoginToken loginToken = userUserCase.signupByThirdParty(socialLoginRequest.toDomain());// 카카오 서버가 반환해준 유저 정보로 로그인 진행
